# GuitarTuner — working notes for Claude Code

Personal Android 16 guitar tuner (6-string only): GuitarTuna-style string preview with cents offset, unlimited
custom tunings, mic or USB audio input (NUX Mighty Plug Pro MP-3). Kotlin + Jetpack Compose + Material 3.
The plan that drives the work lives at `docs/PLAN.md`.
